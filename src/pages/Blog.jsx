...
const Blog = () => {
    const [tabIndx,setTab]=useState(0);
      ...
      <article className='space-y-8 '>
        <div className='space-y-6'>
          ...
          <div className='flex items-center overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap '>
            ...
            <div
              onClick={()=>handleAddToBM(blog)}
              className='bg-primary p-3 ml-5 rounded-full hover:bg-opacity-30 bg-opacity-20 cursor-pointer hover:scale-105 '
            >
