...
const Blogs = () => {
 ...
 if(navigation.state==="loading") return <Loader></Loader>
  ...
  return (
    <section className=" dark:bg-gray-100 py-10 text-gray-100 dark:text-gray-800">
      <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
        <div className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 bg-gray-900 dark:bg-gray-50">
          <img
            ...
            alt=""
            className="object-cover border  w-full h-64 rounded sm:h-96 lg:col-span-7 bg-gray-500 dark:bg-gray-500"
          />
